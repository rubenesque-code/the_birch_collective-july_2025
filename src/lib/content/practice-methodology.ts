const pageContent = {
	...
	'foundations-wellbeing': {
		...
		title: 'Foundations for wellbeing',
		content: [
			{
				type: 'paragraph',
				text: 'It is widely acknowledged that the foundations for wellbeing include:'
			},
			{
				type: 'list',
				items: [
	...
	'trauma-informed': {
		...
		subsections: [
			{
				subtitle: 'Key principles of trauma-informed practice',
				content: [
					{
						type: 'paragraph',
						text: 'There are 6 principles of trauma-informed practice that we incorporate in the ways we work with our participants:'
					},
					{
						type: 'list',
						items: [
							{
								title: 'Safety',
								text: 'The physical, psychological and emotional safety of participants are prioritised'
							},
							{
								title: 'Trustworthiness',
								text: 'Transparency exists in our policies and procedures, with the aim of building trust with our participants and the wider community'
							},
							{
								title: 'Choice',
								text: 'Participants are supported in shared decision-making, choice and goal setting'
							},
							{
								title: 'Collaboration',
								text: "The value of participants' experience is recognised in overcoming challenges and improving the system as a whole"
							},
							{
								title: 'Empowerment',
								text: 'Efforts are made to share power and give participants a strong voice in decision-making, at both individual and organisational level'
							},
							{
								title: 'Cultural consideration',
								text: 'Move past cultural stereotypes and biases based on, for example, gender, sexual orientation, age, religion, disability, geography, race or ethnicity'
							}
						]
					}
				]
			...
			{
				subtitle: 'How we do this at Birch',
				principles: [
					{
						name: 'Safety',
						items: [
